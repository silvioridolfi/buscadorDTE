...
import {
  X, MapPin, Phone, Mail, Building2, User, GraduationCap, Users,
  Clock, Award, Share2, AlertTriangle, Hash, Map, Globe, Calendar,
  Wifi, Network, Layers, FileText, Info,
} from "lucide-react"
...
import { cn, isContextoEncierro, isEscuelaCerrada } from "@/lib/utils"
...
export default function SchoolDetailsOptimized({
  ...
  // Calcular badges una sola vez
  const contextEncierro = school ? isContextoEncierro(school.plan_enlace) : false
  const escuelaCerrada = school ? isEscuelaCerrada(school.plan_enlace) : false
              ...
              <Accordion type="multiple" value={expandedSections} onValueChange={setExpandedSections}>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <KeyValue label="Tipo de establecimiento" value={school.tipo_establecimiento} icon={<Building2 />} />
                ...
                <DetailSection id="educativa" title="Información Educativa" icon={<GraduationCap />}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <KeyValue label="Matrícula total" value={school.matricula ? `${school.matricula} estudiantes` : null} icon={<Users />} />
                ...
                <DetailSection id="conectividad-infraestructura" title="Conectividad e Infraestructura" icon={<Wifi />}>
                  <div className="space-y-8">
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "plan_enlace", label: "Plan Enlace", value: school.plan_enlace, icon: <Network /> },
                        { key: "subplan_enlace", label: "Subplan Enlace", value: school.subplan_enlace, icon: <Network /> },
                        { key: "fecha_inicio_conectividad", label: "Fecha inicio conectividad", value: school.fecha_inicio_conectividad, icon: <Calendar /> },
                        { key: "recurso_primario", label: "Recurso Primario", value: school.recurso_primario, icon: <Building2 /> },
                      ]} />
                    </div>
                    ...
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "proveedor_internet_pnce", label: "Proveedor Internet PNCE", value: school.proveedor_internet_pnce, icon: <Wifi /> },
                        { key: "fecha_instalacion_pnce", label: "Fecha Instalación PNCE", value: school.fecha_instalacion_pnce, icon: <Calendar /> },
                        { key: "pnce_tipo_mejora", label: "PNCE Tipo de mejora", value: school.pnce_tipo_mejora, icon: <Layers /> },
                        { key: "pnce_fecha_mejora", label: "PNCE Fecha de mejora", value: school.pnce_fecha_mejora, icon: <Calendar /> },
                        { key: "pnce_estado", label: "PNCE Estado", value: school.pnce_estado, icon: <AlertTriangle /> },
                        { key: "mb", label: "Velocidad de conexión", value: school.mb ? `${school.mb} MB` : null, icon: <Wifi /> },
                      ]} />
                    </div>
                    ...
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "pba_grupo_1_proveedor_internet", label: "Proveedor Internet PBA - Grupo 1", value: school.pba_grupo_1_proveedor_internet, icon: <Network /> },
                        { key: "pba_grupo_1_fecha_instalacion", label: "Fecha instalación", value: school.pba_grupo_1_fecha_instalacion, icon: <Calendar /> },
                        { key: "pba_grupo_1_estado", label: "Estado PBA - Grupo 1", value: school.pba_grupo_1_estado, icon: <AlertTriangle /> },
                      ]} />
                    </div>
                    ...
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "pba_2019_proveedor_internet", label: "Proveedor Internet PBA 2019", value: school.pba_2019_proveedor_internet, icon: <Network /> },
                        { key: "pba_2019_fecha_instalacion", label: "Fecha instalación PBA 2019", value: school.pba_2019_fecha_instalacion, icon: <Calendar /> },
                        { key: "pba_2019_estado", label: "Estado PBA 2019", value: school.pba_2019_estado, icon: <AlertTriangle /> },
                      ]} />
                    </div>
                    ...
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "pba_grupo_2_a_proveedor_internet", label: "Proveedor Internet PBA - Grupo 2 - A", value: school.pba_grupo_2_a_proveedor_internet, icon: <Network /> },
                        { key: "pba_grupo_2_a_fecha_instalacion", label: "Fecha instalación PBA - Grupo 2 - A", value: school.pba_grupo_2_a_fecha_instalacion, icon: <Calendar /> },
                        { key: "pba_grupo_2_a_tipo_mejora", label: "Tipo de mejora PBA - Grupo 2 - A", value: school.pba_grupo_2_a_tipo_mejora, icon: <Layers /> },
                        { key: "pba_grupo_2_a_fecha_mejora", label: "Fecha de mejora PBA - Grupo 2 - A", value: school.pba_grupo_2_a_fecha_mejora, icon: <Calendar /> },
                        { key: "pba_grupo_2_a_estado", label: "Estado PBA - Grupo 2 - A", value: school.pba_grupo_2_a_estado, icon: <AlertTriangle /> },
                      ]} />
                    </div>
                    ...
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "estado_instalacion_pba", label: "Estado de instalación PBA", value: school.estado_instalacion_pba, icon: <AlertTriangle /> },
                        { key: "proveedor_asignado_pba", label: "Proveedor asignado PBA", value: school.proveedor_asignado_pba, icon: <Network /> },
                        { key: "listado_conexion_internet", label: "Listado por el que se conecta internet", value: school.listado_conexion_internet, icon: <FileText /> },
                        { key: "reclamos_grupo_1_ani", label: "Reclamos Grupo 1 ANI", value: school.reclamos_grupo_1_ani, icon: <AlertTriangle /> },
                        { key: "access_id", label: "Access ID", value: school.access_id, icon: <Hash /> },
                        { key: "tipo", label: "Tipo de establecimiento (técnico)", value: school.tipo, icon: <Building2 /> },
                      ]} />
                    </div>
                    ...
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "plan_piso_tecnologico", label: "Plan Piso Tecnológico", value: school.plan_piso_tecnologico, icon: <Building2 /> },
                        { key: "proveedor_piso_tecnologico_cue", label: "Proveedor Piso Tecnológico CUE", value: school.proveedor_piso_tecnologico_cue, icon: <Building2 /> },
                        { key: "fecha_terminado_piso_tecnologico_cue", label: "Fecha terminado Piso Tecnológico CUE", value: school.fecha_terminado_piso_tecnologico_cue, icon: <Calendar /> },
                        { key: "tipo_piso_instalado", label: "Tipo de Piso instalado", value: school.tipo_piso_instalado, icon: <Building2 /> },
                      ]} />
                    </div>
                    ...
                    <div>
                      ...
                      <KeyValueList items={[
                        { key: "tipo_mejora", label: "Tipo de mejora", value: school.tipo_mejora, icon: <Layers /> },
                        { key: "fecha_mejora", label: "Fecha de mejora", value: school.fecha_mejora, icon: <Calendar /> },
                      ]} />
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {school.contacto && (
                      <div className="space-y-4 p-4 bg-gray-800/30 rounded-lg border border-gray-700">
                        ...
                        <KeyValue label="Nombre completo" value={`${school.contacto.nombre} ${school.contacto.apellido}`} />
